...
<form class="user" action="<?php echo base_url('home/tambah');?>" method="post">
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control form-control-user" id="nama" name="nama" placeholder="Name Maximal 20 Character" require>
        </div>
<div class="form-group">
